...
<head>
	...
	<link r el="stylesheet" href="{{asset('admin/assets/vendor/font-awesome/css/font-awesome.min.css')}}">
			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{asset('admin/assets/img/logo-kalbis2.png')}}" alt="Klorofil Logo" class="img-responsive logo" style="width: 400px; height: 100px;" ></div>
