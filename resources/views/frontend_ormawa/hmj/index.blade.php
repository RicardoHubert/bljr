...
@section('content')
    ...
    <!-- <div class="page-header header-filter header-small" data-parallax="true" style="background-image: url({{url('bg_ormawa/back_tracerstudy.jpg')}});"> -->
        ...
        <img src="{{asset('bg_ormawa/'.$ormawa->bg_ormawa)}}"  style="height: 500px;object-fit:cover;opacity: 0.8;" width="100%">
          <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card-header card-header-image">
                                            <a href="#pablito">
                                                <img class="img" src="{{asset('posterkegiatan/'.$kegiatan->poster)}}" style="max-width: 30%;height: 250px;object-fit: ">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <span class="badge badge-danger">On Progress</span>
                                                    ...
                                                    @else
                                                        ...
                                                        <a href="/pendaftaran_kegiatan/{{$kegiatan->id}}" class="btn btn-sm btn-warning">Daftar</a>
                                                    @endif
        ...
        <div class="container">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2>VISI</h2>
                            <p class="justify"> ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
