...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/skpi-data', 'SkpiController@skpiData')->name("skpi.data");
    Route::post('/skpi/create', 'SkpiController@create')->name("skpi.create");;
    Route::get('/skpi/{id}/delete', 'SkpiController@delete')->name("skpi.destroy");;
