<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="#"><img src="{{asset('admin/assets/img/logokalbis.png')}}" alt="Klorofil Logo" class="img-responsive logo" style="width: 100px"></a>
			</div>
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu"> 		
								<li><a href="{{action('AuthController@logout')}}"><i class="lnr lnr-exit"></i> <span>Logout</span></a></li>
							</ul>
						</li>
						<!-- <li>
